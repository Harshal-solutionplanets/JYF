            ...
            <div className="row">
                <div className="col-lg-4 col-md-12 col-sm-12 col-12">
                    <div className="footer_area_about">
                        ...
                        <p>Jago Welfare Foundation (JYF) - Unity in commUNITY. Emprowering lives through service and welfare.</p>
                        <h6><strong>Address:</strong> [Update with actual address]</h6>
                        <h6><strong>Phone:</strong> <Link to="tel:+91XXXXXXXXXX">+91 XXXXX XXXXX</Link></h6>
                        <h6><strong>Email:</strong> <Link to="mailto:info@jyf.org">info@jyf.org</Link></h6>
                    </div>
                </div>
